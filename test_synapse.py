...
parser.add_argument(
    '--volume_path',
    type=str,
    default='/mnt/harddisk1/Yuecaihan/codespace/EMCAD-main/data/synapse/test_vol_h5',
...
if __name__ == "__main__":
    ...
    args.exp = (
        args.encoder
        + '_EMCAD_kernel_sizes_DRP-enhanced-149'
    ...
    snapshot = os.path.join(
        snapshot_path,
        '/mnt/harddisk1/Yuecaihan/codespace/EMCAD-main/model_pth/pvt_v2_b2_EMCAD_kerne_sizes_DRP-enhanced1_3_5_dw_parallel_add_lgag_ks_3_ef2_act_mscb_relu6_loss_mutation_output_final_layer_Run1_Synapse224/pvt_v2_b2_EMCAD_kernel_sizes_1_3_5_dw_parallel_add_lgag_ks_3_ef2_act_mscb_relu6_loss_mutation_output_final_layer_Run1_pretrain_bs6_224_s2222/epoch_149.pth'
    )
